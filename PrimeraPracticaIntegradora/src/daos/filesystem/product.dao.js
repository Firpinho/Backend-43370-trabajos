...
class ProductDaoFS {
  ...
  async getById(id) {
    ...
    if (!this.#product_exists(products, id)) return false;
  ...
  async create(data) {
    ...
    if (this.#validate_fields(product))
      return {
        status: false,
        message: "Err. Campos vacios: Todos los campos son obligatorios.",
      };
  ...
  async update(id, data) {
    ...
    if (!this.#product_exists(products, id))
      return {
        status: false,
        message: "Err. No existe: No existe un producto con este ID.",
      };
